% helloworlddca(SECTION) | User Commands
%
% "October  9 2024"
...
helloworlddca - program to do something

# SYNOPSIS

**helloworlddca** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**helloworlddca** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **helloworlddca** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**helloworlddca** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    helloworlddca. See **foo.conf**(5) for further details.
...
**helloworlddca** provides some return codes, that can be used in scripts:
